...
class TrainingSchedulePolicy
{
    ...
    {
        return $user->can('view_any_training::schedule');
    }
    ...
    {
        return $user->can('view_training::schedule');
    }
    ...
    {
        return $user->can('create_training::schedule');
    }
    ...
    {
        return $user->can('update_training::schedule');
    }
    ...
    {
        return $user->can('delete_training::schedule');
    }
    ...
    {
        return $user->can('delete_any_training::schedule');
    }
     ...
     */
    public function replicate(User $user, TrainingSchedule $trainingSchedule): bool
    {
